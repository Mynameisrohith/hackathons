export const translations = {
  en: {
    ...
    creditDebitCardDesc: 'Pay with Visa, MasterCard, and RuPay',
    upi: 'UPI',
    upiDesc: 'Pay with any UPI app via Razorpay',
  ...
  kn: {
    ...
    creditDebitCardDesc: 'ವೀಸಾ, ಮಾಸ್ಟರ್‌ಕಾರ್ಡ್, ಮತ್ತು ರುಪೇ ಮೂಲಕ ಪಾವತಿಸಿ',
    upi: 'ಯುಪಿಐ',
    upiDesc: 'ಯಾವುದೇ ಯುಪಿಐ ಅಪ್ಲಿಕೇಶನ್ ಮೂಲಕ ರೇಜರ್‌ಪೇ ಬಳಸಿ ಪಾವತಿಸಿ',
